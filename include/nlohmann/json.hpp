    ...
    : public ::nlohmann::detail::json_base_class<CustomBaseClass>
{
  ...
  JSON_PRIVATE_UNLESS_TESTED:
    ...
    static ::nlohmann::detail::parser<basic_json, InputAdapterType> parser(
        ...
        const std::size_t max_depth = (std::numeric_limits<std::size_t>::max)()
    )
    {
        return ::nlohmann::detail::parser<basic_json, InputAdapterType>(std::move(adapter),
               std::move(cb), allow_exceptions, ignore_comments, ignore_trailing_commas, max_depth);
    }
...
#undef JSON_IMPLEMENT_OPERATOR
    ...
    {
        basic_json result;
        parser(detail::input_adapter(std::forward<InputType>(i)), std::move(cb), allow_exceptions, ignore_comments, ignore_trailing_commas, max_depth).parse(true, result); // cppcheck-suppress[accessMoved,accessForwarded]
        return result;
    }
    ...
    {
        basic_json result;
        parser(detail::input_adapter(std::move(first), std::move(last)), std::move(cb), allow_exceptions, ignore_comments, ignore_trailing_commas, max_depth).parse(true, result); // cppcheck-suppress[accessMoved]
        return result;
    }
    ...
    {
        basic_json result;
        parser(i.get(), std::move(cb), allow_exceptions, ignore_comments, ignore_trailing_commas, max_depth).parse(true, result); // cppcheck-suppress[accessMoved]
        return result;
    }
    ...
    static bool accept(InputType&& i,
                       ...
                       const std::size_t max_depth = (std::numeric_limits<std::size_t>::max)())
    {
        return parser(detail::input_adapter(std::forward<InputType>(i)), nullptr, false, ignore_comments, ignore_trailing_commas, max_depth).accept(true);
    }
    ...
    static bool accept(IteratorType first, IteratorType last,
                       ...
                       const std::size_t max_depth = (std::numeric_limits<std::size_t>::max)())
    {
        return parser(detail::input_adapter(std::move(first), std::move(last)), nullptr, false, ignore_comments, ignore_trailing_commas, max_depth).accept(true);
    }
    ...
    static bool accept(detail::span_input_adapter&& i,
                       ...
                       const std::size_t max_depth = (std::numeric_limits<std::size_t>::max)())
    {
        return parser(i.get(), nullptr, false, ignore_comments, ignore_trailing_commas, max_depth).accept(true);
    }
